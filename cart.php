...
<html lang="en">
  ...
  <body>
	<div id="loadingDiv" style="position: fixed;height: 100%;width: 100%;background: #000000cf;z-index: 100000;display: none;">
		<img src="images/assets/loader.gif" alt="" style="position: fixed;top: 50%;left: 50%;width: 200px;transform: translate(-50%, -50%);">
	</div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        <a class="navbar-brand" href="index">KEZABITE</a>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-4">
            <h1 class="mb-2 bread">Welcome to Cart</h1>
    ...
    <section style="padding: 10px" id="ftco-section">
      <div class="container">
          <div class="row">
            <div class="col-md-8">
              ...
              <div>
                <div style="float: left;">
                  <a href="cart?cmd=emptycart" type="button" class="btn btn-warning">Empty Cart</a>
                </div>
            ...
            <div class="col-md-4">
              <div style="border: 1px solid lightgrey; border-radius: 3px;padding: 10px">
                <form method="post">
                  <h5 class="card-header">Customer details</h5>
                  <div class="form-group">
                    <label class="label">Client Names</label>
                    <input type="text" id="clientnames" placeholder="Eg: Keza Bite" class="form-control">
                  </div>
                  <div class="form-group">
                    <label class="label">Telephone</label>
                    <input type="text" id="clientphone" placeholder="Eg: 250784143392" class="form-control">
                  </div>
                  <div class="form-group">
                    <label class="label">Delivery Address</label>
                    <input type="text" id="shippingaddress" placeholder="Eg: Kacyiru" class="form-control">
                  </div>
                  <div class="form-group">
                  ...
                  <!-- <div style="display: flex;justify-content: space-around;">
                    <img id="mtnpaymentimg" src="images/payment/mtn_payment.png" style="position: relative;width: 30%;cursor: pointer;">
                    <img id="airtelpaymentimg" src="images/payment/airtel_payment1.png" style="position: relative;width: 30%;cursor: pointer;">
                    <img id="cardspaymentimg" src="images/payment/visamaster.png" style="position: relative;width: 30%;cursor: pointer;">
                  </div> -->
                  <div id="mtnpaymentdiv">
                    ...
                    <!-- custombtn -->
                    <p id="result" class="text-orange"></p>
                    <a href="javascript:;" class="btn btn-sm btn-success text-white pull right" onclick="mtnpay()">PAY <?php echo number_format($cartTotal)?> RWF</a>
                    <!-- custombtn -->
                  </div>
                </form>
              </div>
  ...
  <script type="text/javascript">
  	function mtnpay() {
  		var clientnames = document.getElementById('clientnames').value;
  		if (clientnames=='') {
  			alert("Please give us your names");
  			return false;
  		}
  		var clientphone = document.getElementById('clientphone').value;
  		if (clientphone=='') {
  			alert("Please give us your mobile number");
  			return false;
  		}
  		var shippingaddress = document.getElementById('shippingaddress').value;
  		if (shippingaddress=='') {
  			alert("Please give us shipping address");
  			return false;
  		}
  		...
  		var mtnpaynumber = document.getElementById('mtnpaynumber').value;
  		if (mtnpaynumber=='') {
  			alert("Please give  us payment mobile number");
  			return false;
  		}
		...
		$.ajax({
		    ...
		    error : function(xht, textStatus, errorThrown){
		    	document.getElementById('loadingDiv').style.display='none';
		    	document.getElementById('result').innerHTML=errorThrown;
		    }
		});
  	}
	function confirm() {
	    myVar = setTimeout(showConfirm, 7000);
	}
